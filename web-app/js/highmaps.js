...
(function () {
                ...
                a.fn.highcharts = function () {
                    ...
                    if (this[0]) {
                        ...
                        if (c !== s) c.chart = c.chart || {},
                            c.chart.renderTo = this[0], new K[a](c, b[1]), d = this;
        ...
        fa = function (a) {
            ...
            (function (a) {
                a && a.stops ? d = Ua(a.stops, function (a) {
                    ...
                    z(c[3]), parseFloat(c[4], 10)
                ] : (c = Ob.exec(a)) ? b = [z(c[1], 16), z(c[2], 16), z(c[3], 16), 1] : (c = Pb.exec(a)) && (b = [z(c[1]), z(c[2]), z(c[3]), 1])
            })(a);
            return {
                get: function (c) {
                    var f;
                ...
                brighten: function (a) {
                    if (d) p(d, function (b) {
                        ...
                        var c;
                        for (c = 0; c < 3; c++) b[c] += z(a * 255), b[c] < 0 && (b[c] =
                            0), b[c] > 255 && (b[c] = 255)
                    }
                    return this
                },
    ...
    ba.prototype = {
                ...
                p(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            if (l)
                                for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), o = n || e.length > 1 && k.whiteSpace !== "nowrap", p, C, s = k.HcHeight, q = [], t = J(v), Db = 1; o && (e.length || q.length);) delete a.bBox, p = a.getBBox(), C = p.width, !ca && c.forExport && (C = c.measureSpanWidth(v.firstChild.data, a.styles)), p = C > l, !p || e.length === 1 ?
        ...
        fontMetrics: function (a, b) {
            ...
            if (b && H.getComputedStyle) b = b.element || b, a = H.getComputedStyle(b,
                "").fontSize;
    ...
    if (!ca && !ha) S = {
        ...
        setSpanRotation: function () {
            ...
            G(this.element, {
                filter: a ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", b, ", M12=", -c, ", M21=", c,
                    ", M22=", b, ", sizingMethod='auto expand')"
                ].join("") : U
            })
        },
        ...
        fillSetter: function (a, b, c) {
            ...
            else if (d !== "IMG") c.filled = a !== U, this.setAttr("fillcolor", this.renderer.color(a,
                c, b, this))
        },
        opacitySetter: aa,
        ...
        color: function (a, b, c, d) {
            ...
            if (i) {
                ...
                if (c === "fill")
                    if (i === "gradient") c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, o = n.x2 || n[2] || 0, n = n.y2 || n[3] || 0, x = 'angle="' + (90 - M.atan((n - a) / (o - c)) * 180 / gb) + '"', u();
                    else {
                        var j = n.r,
                            t = j * 2,
                            w = j * 2,
    ...
    Ka.prototype = {
        ...
        handleOverflow: function (a, b) {
            ...
            if (n) {
                ...
                do a += e ? 1 : -1, o = d.ticks[i[a]]; while (i[a] && (!o || !o.label || o.label.line !== m));
        ...
        render: function (a, b, c) {
            ...
            if (i && !isNaN(B)) i.xy = r = this.getLabelPosition(B, r, i, g, k, w, a, u), this.isFirst && !this.isLast && !m(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !m(e.showLastLabel,
    ...
    V.prototype = {
        ...
        defaultLabelFormatter: function () {
            ...
            if (h) g = Ia(h, this);
                ...
                for (; f-- && g === s;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = ua(b / c, -1) + e[f]);
        ...
        setTickPositions: function (a) {
            ...
            if (b.range && t(b.max)) b.userMin = b.min = u(b.min, b.max - b.range), b.userMax = b.max, b.range =
                null;
            ...
            if (!a)!b.ordinalPositions && (b.max - b.min) / b.tickInterval > u(2 * b.len, 200) && ma(19, !0), a = f ? b.getTimeTicks(b.normalizeTimeTickInterval(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions,
            ...
            if (j || a.isLinked) {
                ...
                if (a.horiz && !a.staggerLines && w && !J.rotation) {
                    for (j = a.reversed ? [].concat(e).reverse() : e; r < w;) {
                        ...
                        A = !1;
                        for (q =
                            0; q < j.length; q++) B = j[q], L = (L = f[B].label && f[B].label.getBBox()) ? L.width : 0, z = q % r, L && (B = a.translate(B), y[z] !== s && B < y[z] && (A = !0), y[z] = B + L);
                        if (A) r++;
                        else break
                    }
                ...
                for (q in f) f[q].destroy(), delete f[q]; if (v && v.text && v.enabled !== !1) {
        ...
        drawCrosshair: function (a, b) {
            if (this.crosshair)
                if ((t(b) ||
                    !m(this.crosshair.snap, !0)) === !1) this.hideCrosshair();
                else {
    ...
    Fb.prototype = {
        ...
        hide: function () {
            var a = this,
                b;
            clearTimeout(this.hideTimer);
            if (!this.isHidden) b = this.chart.hoverPoints, this.hideTimer =
                setTimeout(function () {
                    a.label.fadeOut();
                    a.isHidden = !0
    ...
    za.prototype = {
        ...
        runPointActions: function (a) {
            ...
            if (d && this.options.tooltip.shared && (!h || !h.noSharedTooltip)) {
                ...
                i = c.length;
                for (j = 0; j < i; j++)
                    if (c[j].visible && c[j].options.enableMouseTracking !== !1 && !c[j].noSharedTooltip && c[j].singularTooltips !== !0 && c[j].tooltipPoints.length && (e = c[j].tooltipPoints[l]) && e.series) e._dist = P(l - e.clientX),
    ...
    Xa.prototype = {
        init: function (a, b) {
            var c = this,
                ...
                f = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e -
    ...
    pa.prototype = {
        ...
        getMargins: function () {
            ...
            if (c.display && !e.floating)
                ...
                if (!t(d[0])) this.plotTop = u(this.plotTop, c.legendHeight +
                    h + f + a[0])
    ...
    R.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData) p(a, function (a, b) {
                ...
                if (v && h > v) {
                    ...
                    if (ka(k)) {
                        ...
                        if (r)
                            for (c = 0; c < h; c++) i = a[c], q[c] = i[0], C[c] = i.slice(1, r + 1);
                        else
                            for (c = 0; c < h; c++) i = a[c], q[c] = i[0], C[c] = i[1];
                    else ma(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== s && (i = {
        ...
        processData: function (a) {
            ...
            if (l && this.sorted && (!j || d > j || this.forceCrop))
                if (n = h.getExtremes(), o = n.min, n = n.max, b[d - 1] < o || b[0] > n) b = [], c = [];
                else if (b[0] < o || b[d - 1] > n) e = this.cropData(this.xData,
        ...
        generatePoints: function () {
            ...
            if (b && (g !== (c = b.length) || j))
                for (n = 0; n < c; n++)
                    if (n === h &&
                        !j && (n += g), b[n]) b[n].destroyElements(), b[n].plotX = s;
            this.data = b;
            this.points = l
        },
        ...
        translate: function () {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement, j = i === "between" || ka(i), k = a.threshold, a = 0; a < g; a++) {
                ...
                if (b && this.visible &&
                    q && q[n]) q = q[n], o = q.points[this.index + "," + a], p = o[0], o = o[1], p === 0 && (p = m(k, e.min)), e.isLog && p <= 0 && (p = null), l.total = l.stackTotal = q.total, l.percentage = q.total && l.y / q.total * 100, l.stackY = o, q.setOffset(this.pointXOffset || 0, this.barW || 0);
            ...
            if (d.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = ea(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = p && i.enabled === s || i.enabled, n = c.isInsidePlot(w(d), e, c.inverted), a && e !== s && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = m(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[n ? "show" : "hide"](!0).animate(q({
                            x: d - h,
                            y: e - h
                        }, k.symbolName ? {
                            width: 2 * h,
                            ...
                            if (n && (h > 0 || j)) g.graphic = c.renderer.symbol(i, d - h, e - h, 2 * h, 2 *
                                h).attr(a).add(o)
    ...
    q(V.prototype, {
        ...
        remove: function (a) {
            for (var b = this.chart, c = this.coll,
                d = this.series, e = d.length; e--;) d[e] && d[e].remove(!1);
            ta(b.axes, this);
            ta(b[c], this);
            ...
            for (I = 2; I--;) {
                ...
                if (H) {
                    ...
                    if (l > 0) {
                        ...
                        for (B = 0; B < H; B++) {
                            ...
                            if (D < B && F[B] !==
                                ...
                                for (t < H - B + D && F[B] !== null && (D = t - H + B); F[D] === null;) D++;
                            K.push({
                                i: D,
                                y: F[D]
                            });
                    ...
                    for (B = 0; B < H; B++) {
                        ...
                        r.connX = A;
                        r.connY = z;
                        if (this.options.size === null) t = r.width,
    ...
    q(eb.prototype, {
        ...
        getPlotLinePath: function (a, b, c, d, e) {
            return e ? this.horiz ? ["M", e - 4, this.top - 6, "L", e + 4, this.top -
                6, e, this.top, "Z"
            ] : ["M", this.left, e, "L", this.left - 6, e + 6, this.left - 6, e - 6, "Z"] : V.prototype.getPlotLinePath.call(this, a, b, c, d)
        },
        update: function (a, b) {
            p(this.series, function (a) {
                a.isDirtyData = !0
    ...
    var Gb = da(ja, {
        ...
        onMouseOut: function () {
            var a = this,
                ...
                f = e && (e.duration || 500),
                g;
            if (f && c.rgba.length === 4 && d.rgba.length === 4 && a.state !== "select") g = a.pointAttr[""].fill, delete a.pointAttr[""].fill,
    ...
    r.map = da(r.scatter, y(S, {
        ...
        getBox: function (a) {
            ...
            if (j) {
                ...
                if (h && h.options.minRange === void 0) h.minRange = Math.min(5 * g, (this.maxX - this.minX) / 5, h.minRange ||
                    b);
        ...
        translatePath: function (a) {
            ...
            if (a)
                for (i =
                    a.length; i--;) typeof a[i] === "number" ? (j[i] = b ? (a[i] - e) * f + c : (a[i] - g) * h + d, b = !b) : j[i] = a[i];
            return j
        },
        setData: function (a, b) {
            ...
            if (d) {
                ...
                this.mapData = d;
                this.mapMap = {};
                for (j = 0; j < d.length; j++) h = d[j], i = h.properties, h._i = j, e[0] && i &&
                    i[e[0]] && (h[e[0]] = i[e[0]]), this.mapMap[h[e[0]]] = h;
        ...
        translate: function () {
            ...
            p(a.data, function (d) {
                ...
                if (a.isDirtyData || a.chart.renderer.isVML) d.shapeType = "path",
                    d.shapeArgs = {
        ...
        drawPoints: function () {
            ...
            this.isDirtyData || e.isVML || !f ? (d.hasRendered && this.pointAttrToOptions.fill === "color" && p(this.points, function (a) {
                ...
                }), this.group = this.transformGroup, r.column.prototype.drawPoints.apply(this),
                this.group = c, p(this.points, function (a) {
                    ...
                    transAX: a.transA,
                    transAY: b.transA
                }) : (c = a.transA / f.transAX, d = b.transA / f.transAY, c > 0.99 && c < 1.01 && d > 0.99 && d < 1.01 ? (b = a = 0, d = c =
                1) : (a = a.toPixels(f.originX, !0), b = b.toPixels(f.originY, !0)), this.transformGroup.animate({
                translateX: a,
                translateY: b,
                scaleX: c,
                scaleY: d
        ...
        hideOverlappingDataLabels: function () {
            ...
            for (c = 0; c < b - 1; ++c) {
                e =
                    a[c].dataLabel;
                for (d = c + 1; d < b; ++d)
                    if (f = a[d].dataLabel, e && f && e.newOpacity !== 0 && f.newOpacity !== 0 && !(f.alignAttr.x > e.alignAttr.x + e.width || f.alignAttr.x + f.width < e.alignAttr.x || f.alignAttr.y > e.alignAttr.y + e.height || f.alignAttr.y + f.height < e.alignAttr.y))(a[c].labelrank < a[d].labelrank ? e : f).newOpacity = 0
            }
            p(a, function (a, b) {
                if (b = a.dataLabel) {
    ...
    q(pa.prototype, {
        renderMapNavigation: function () {
            ...
            if (m(b.enableButtons, b.enabled) && !a.renderer.forExport)
                for (d in c)
                    if (c.hasOwnProperty(d)) f = y(b.buttonOptions, c[d]), e = f.theme, g = e.states, e = a.renderer.button(f.text, 0, 0, h, e, g && g.hover, g && g.select, 0, d === "zoomIn" ? "topbutton" : "bottombutton").attr({
                        width: f.width,
                        height: f.height,
    ...
    q(za.prototype, {
        onContainerDblClick: function (a) {
            var b = this.chart,
                a = this.normalize(a);
            b.options.mapNavigation.enableDoubleClickZoomTo ? b.pointer.inClass(a.target, "highcharts-tracker") && b.hoverPoint.zoomTo() : b.isInsidePlot(a.chartX - b.plotLeft, a.chartY - b.plotTop) && b.mapZoom(0.5, b.xAxis[0].toValue(a.chartX), b.yAxis[0].toValue(a.chartY),
                a.chartX, a.chartY)
        },
    ...
    Y(za.prototype, "pinchTranslate", function (a,
        b, c, d, e, f, g) {
    ...
    var Rb = da(ja, {
        haloPath: function () {
            return ja.prototype.haloPath.call(this,
    ...
    r.bubble = da(r.scatter, {
        ...
        convertAttribs: function () {
            var a = R.prototype.convertAttribs.apply(this,
                arguments);
    ...
    V.prototype.beforePadding = function () {
        ...
        this.tickPositions && (p(this.series, function (b) {
            ...
            if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries))
                if (a.allowZoomOutside = !0, q.push(b), f) p(["minSize", "maxSize"], function (a) {
                        var b = d[a],
                            c = /%$/.test(b),
                            b = z(b);
                        i[a] = c ? j * b / 100 : b
            ...
            if (n > 0)
                for (; c--;) typeof b[c] === "number" && (j = a.radii[c], d = Math.min((b[c] - h) * o - j, d), e = Math.max((b[c] - h) * o + j, e))
    ...
    K.geojson = function (a, b, c) {
        ...
        if (c) c.chart.mapCredits = '<a href="http://www.highcharts.com">Highcharts</a> © <a href="' + a.copyrightUrl + '">' + a.copyrightShort +
            "</a>";
        return d
    };
            ...
            if (!(this.options.enableMouseTracking === !1 || this.singularTooltips)) {
                ...
                for (i = 0; i < a; i++)
                    if (e = b[i], c = e.x, c >= f.min && c <= f.max) {
                        ...
                        c = d === s ? 0 : d + 1;
                        for (d = b[i + 1] ? D(u(0,
                            ea((e.clientX + (h ? h.wrappedClientX || h.clientX : g)) / 2)), g) : g; c >= 0 && c <= d;) j[c++] = e
                    }
