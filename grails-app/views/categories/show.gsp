...
<html>
	...
	<body>
		<a href="#show-categories" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-categories" class="content scaffold-show" role="main">
			...
			<ol class="property-list categories">
				...
				<li class="fieldcontain">
					<span id="name-label" class="property-label"><g:message code="categories.name.label" default="Name" /></span>
					
						<span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${categoriesInstance}" field="name"/></span>
