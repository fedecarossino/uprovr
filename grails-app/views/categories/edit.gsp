...
<html>
	...
	<body>
		<a href="#edit-categories" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-categories" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:categoriesInstance, action:'update']" method="PUT" >
